...
export function Notebook({ cells, dataset, onSubmit, onConfirm, onClarify }: NotebookProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {cells.map(cell => (
          <NotebookCell key={cell.id} cell={cell} onConfirm={onConfirm} onClarify={onClarify} />
        ))}
